...
def get_mark_nodes(points_ploygon_input_test, apartments_need_test, num_elevators_test, paths_png_test,
                   paths_graph_test):
    """
    输入边界得到内部的分割点
    :param paths_png_test: 图片储存地址列表
    :param points_ploygon_input_test: 输入的边界点
    :param apartments_need_test:  需要的套型面积以及数量
    :param num_elevators_test:  输入需要的电梯个数
    :param paths_graph_test:  图结构储存地址列表
    :return:
    """
    # 得到的图像种边界和区域
    ...
    for id in list_ids_now[0:3]:  # 遍历所选出来的
        ...
        list_nodes_mark.append(point_new)  # 所有的分割点的数据
    ...
    return img_input, list_nodes_mark
...
if __name__ == '__main__':
    ...
    # 平面图库
    paths_png_test_1 = [r'F:\Dataset_zjkj_4_channel_graph\dataset_png_other',
                        r'F:\Dataset_zjkj_4_channel_graph\dataset_png_zjkj']

    # 图结构库
    paths_graph_test_1 = [r'F:\Dataset_zjkj_4_channel_graph\dataset_graph_other',
                          r'F:\Dataset_zjkj_4_channel_graph\dataset_graph_zjkj']
