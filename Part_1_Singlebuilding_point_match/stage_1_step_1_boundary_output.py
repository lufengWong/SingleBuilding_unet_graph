...
def from_input_get_pix(points_ploygon_input, apartments_need,
    ...
    return (np.array(points_new_in_pic) * utils.size_grid).tolist()
...
if __name__ == '__main__':
    ...
    points_new_in_pic = from_input_get_pix(points_ploygon_input_1, apartments_need_1)
    # print(data_need)
    # print(points_new_in_pic)  # 平移缩放之后的


    # 保存边界
    path_boundary = r'C:\Users\Administrator\Desktop\singleBuilding_unet_graph\data_gererate'
    with open(os.path.join(path_boundary, 'boundary.txt'), 'w') as f:
        # f.write('Points')
        # f.write('\n')
