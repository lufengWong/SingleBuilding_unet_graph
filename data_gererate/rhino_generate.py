...
path_segment = r'C:\Users\Administrator\Desktop\singleBuilding_unet_graph\Part_3_SingleBuilding_findCounter\2.txt'
...
# add text
text = rs.AddText("Elevator", [18000, 13000, 5000], 800)

rs.ObjectColor(text, (0, 0, 255))  # 将文字对象颜色设置为红色
