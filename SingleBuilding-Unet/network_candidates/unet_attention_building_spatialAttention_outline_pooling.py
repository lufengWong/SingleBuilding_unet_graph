...
class UNet(nn.Module):  # UNet AttU_Net
    def __init__(self, img_ch=7, output_ch=1):
        ...
        self.Con1_4 = nn.Conv2d(in_channels=14, out_channels=1, kernel_size=1)
        self.Con1_5 = nn.Conv2d(in_channels=14, out_channels=1, kernel_size=1)
        self.Con1_6 = nn.Conv2d(in_channels=14, out_channels=1, kernel_size=1)
        self.Con1_7 = nn.Conv2d(in_channels=14, out_channels=1, kernel_size=1)
